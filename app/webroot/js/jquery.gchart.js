...
(function ( $ ) {    
    $.gChart = function(options){
        ...
        if(typeof google != 'undefined' ) {
            ...
            function drawBasic() {
                ...
                data.addColumn('number', 'User'); // Implicit series 1 data col.
                data.addRows(arr);
    ...
    $.gChartDateRange = function( startChangeDate, endChangeDate ){
    	if(typeof startChangeDate == 'undefined' ) {
            startChangeDate = false;
        }
        if(typeof endChangeDate == 'undefined' ) {
            endChangeDate = false;
        }
	    ...
	    $('.daterange-dasboard').daterangepicker(
	        range_options,
	        function(start, end) {
        ...
        $('.kpr-chart').click(function() {
	        ...
	        if( startChangeDate != false && endChangeDate != false ) {
	        	ajax_url += '/'+startChangeDate+'/'+endChangeDate+'/';
	    	}
