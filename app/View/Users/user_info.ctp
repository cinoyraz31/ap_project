...
<div class="user-info-form text-center">
    ...
    <div class="wrapper-user-info">
            ...
            <div class="btn-group tracker-group-id" data-toggle="buttons">
                ...
                <label class="btn btn-default action" data-value="1">
                    <?php 
                            ...
                            echo $this->Html->tag('span', __('Non-Agen'));
                    ?>
                </label>
            </div>
            <?php 
        ...
        <div class="form-group">
            <?php
                    echo $this->Html->tag('small', sprintf(__(' Anda dapat menklasifikasikan diri Anda di kemudian hari. %s.'), $this->Html->link(__('Pelajari lebih lanjut'), '#')));
            ?>
        </div>
        <div class="form-group">
            <?php
