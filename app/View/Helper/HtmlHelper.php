 ...
 */
	public function tableCells($data, $class = array(), $oddTrOptions = null, $evenTrOptions = null, $useCount = false, $continueOddEven = true) {
		...
		foreach ($data as $line) {
			...
			$options = $this->_parseAttributes($class);
